...
|--------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------- |
| __CORE__ ||||
| `ENV` or `JAVA_ENV`                                      | Type: String<br>Required: No<br>Default Value: unknown<br>Sample Value: production                                                                                                           | String sent to Honeybadger indicating running environment (eg development, test, staging, production, etc).                                                                                              |
| `honeybadger.api_key` or `HONEYBADGER_API_KEY`           | Type: String<br>Required: Yes<br>Default Value: N/A<br>Sample Value: 29facd41                                                                                                                | The API key found in the settings tab in the Honeybadger UI.                                                                                                                                             |
| `honeybadger.application_package`                        | Type: String<br>Required: No<br>Default Value: N/A<br>Sample Value: my.app.package                                                                                                           | Java application package name used to indicate to Honeybadger what stacktraces are within the calling application's code bade.                                                                           |
| `honeybadger.excluded_exception_classes`                 | Type: CSV<br>Required: No<br>Default Value: N/A<br>Sample Value: org.apache.catalina.connector.ClientAbortException,com.myorg.AnnoyingException                                              | CSV of Java classes in which errors are never sent to Honeybadger. This is useful for errors that are bubbled up from underlying frameworks or application servers like Tomcat.                          |
| `honeybadger.excluded_sys_props`                         | Type: CSV<br>Required: No<br>Default Value: honeybadger.api_key,honeybadger.read_api_key,<br>honeybadger.excluded_sys_props,honeybadger.url<br>Sample Value: bonecp.password,bonecp.username | CSV of Java system properties to exclude from being logged to Honeybadger. This is useful for excluding authentication information. Default values are automatically added.                              |
| `honeybadger.excluded_params`                            | Type: CSV<br>Required: No<br>Default Value: N/Abr>Sample Value: auth_token,session_data,credit_card_number                                                                                   | CSV of HTTP GET/POST query parameter values that will be excluded from the data sent to Honeybadger. This is useful for excluding authentication information, parameters that are too long or sensitive. |
| &nbsp;||||
| __FEEDBACK_FORM__||||
| `honeybadger.display_feedback_form`                      | Type: Boolean<br>Required: No<br>Default Value: true<br>Sample Value: false                                                                                                                  | Displays the feedback form or JSON output when an error is thrown via a servlet call.                  
| `honeybadger.feedback_form_template_path`                | Type: String<br>Required: No<br>Default Value: templates/feedback-form.mustache<br>Sample Value: templates/my-company.mustache                                                               | Path within the class path to the mustache template that is displayed when an error occurs in a servlet request.                                                                                         |
| &nbsp;||||
| __NETWORK__||||
| `http.proxyHost`                                         | Type: String<br>Required: No<br>Default Value: N/A<br>Sample Value: localhost                                                                                                                | Standard Java system property for specifying the host to proxy all HTTP traffic through.
| `http.proxyPort`                                         | Type: Integer<br>Required: No<br>Default Value: N/A<br>Sample Value: 8888                                                                                                                    | Standard Java system property for specifying the port to proxy all HTTP traffic through.                                                                                                                 |
| &nbsp;||||
| __DEVELOPMENT__||||
| `honeybadger.read_api_key` or `HONEYBADGER_READ_API_KEY` | Type: String<br>Required: When testing<br>Default Value: N/A<br>Sample Value: qjcp6c7Nv9yR-bsvGZ77                                                                                           | API key used to access the Read API.                                                                                                                                                                     |
| `honeybadger.url`                                        | Type: String<br>Required: No<br>Default Value: https://api.honeybadger.io<br>Sample Value: https://other.hbapi.com                                                                           | URL to the Honeybadger API endpoint. You may want to access it without SSL in order to test with a proxy utility.                                                                                        |
